...
public class CardVisual : MonoBehaviour
{
    ...
    [SerializeField] private float scaleOnHover = 0.8f;
    [SerializeField] private float scaleOnSelect = 0.9f;
    ...
    public void SetTexts(bool isVisible)
    {
        if(!isVisible)
        {
            Tittle.SetText("");
        ...
        Tittle.SetText(parentCard.CardTittle.ToUpper());
        Description.SetText(parentCard.CardDescription);
        Tipo.SetText($"•{parentCard.Clasification}•");
    ...
    {
        // if(state == true)
        //     GameManager.Instance.PlayerSelectedCard?.cardVisual.Select(GameManager.Instance.PlayerSelectedCard, false);
        ...
        GameManager.Instance.PlayerSelectedCard = card;
    ...
    private void EndDrag(Card card)
    {
        ...
        transform.DOScale(0.7f, scaleTransition).SetEase(scaleEase);
    }

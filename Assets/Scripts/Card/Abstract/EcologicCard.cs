        ...
        set{
            ...
            switch(value)
            {
                case EcologicCradType.EducacionAmbiental:
                    ...
                    CardDescription = "Ésta carta te permite robar 2 cartas y descartar 1 residuo";
                ...
                case EcologicCradType.EnergiaLimpia:
                    ...
                    Clasification = "Accion";
                    CardDescription = "Esta carta elimina el último proyecto contaminante de tu campo";
                ...
                case EcologicCradType.ReciclajeUrbano:
                    ...
                    Clasification = "Accion";
                    CardDescription = "Ésta carta te permite obtener 2 materiales reciclados";
                ...
                case EcologicCradType.SubvencionGubernamental:
                    ...
                    Clasification = "Accion";
                    CardDescription = "Ésta carta te permite obtener 3 materiales reciclados";
                ...
                case EcologicCradType.ContaminacionAire:
                    ...
                    CardDescription = "Ésta carta reduce a la mitad los puntos de sostenibilidad del adversario por turno, solo puede ser anulada con una carta de ENERGÍA LIMPIA";
                ...
                case EcologicCradType.ResiduosToxicos:
                    ...
                    Clasification = "Desafio";
                    CardDescription = "Ésta carta obliga al oponente a descartar 2 cartas aleatorias u obtener 3 residuos, en caso de no tener más de 3 cartas, se verá obligado a obtener 3 residuos";
                ...
                case EcologicCradType.SequiaExtrema:
                    ...
                    Clasification = "Desafio";
                    CardDescription = "Ésta carta impide que los proyectos de Infraestructura de tu oponente generen puntos de sostenibilidad y obtenga 1 residuo/turno durante 5 turnos";
                ...
                case EcologicCradType.CumbreClimatica:
                    ...
                    Clasification = "Colaboracion";
                    CardDescription = "Ésta carta permite que todos descartan 2 residuos y roben 1 carta. Si no se tienen residuos no aplica efecto";
                ...
                case EcologicCradType.InnovacionCompartida:
                    ...
                    Clasification = "Colaboracion";
                    CardDescription = "Ésta carta te permite copiar a tu campo un proyecto de Recurso del jugador contrario, si no dispone de proyectos no aplica efecto";
                ...
                case EcologicCradType.EdificioVerde:
                    ...
                    CardDescription = "Ésta carta te permite generar 1 punto de sostenibilidad/turno y descartar 1 residuo/turno. Requiere 8 de materia prima para jugar";
                ...
                case EcologicCradType.ParqueEolico:
                    ...
                    Clasification = "Infraestructura";
                    CardDescription = "Ésta carta te permite obtener 2 puntos de sostenibilidad/turno. Requiere 12 de materia prima para jugar";
                ...
                case EcologicCradType.TransporteElectrico:
                    ...
                    Clasification = "Infraestructura";
                    CardDescription = "Ésta carta te permite obtener 3 puntos de sostenibilidad/turno. Requiere 18 de materia prima para jugar";
                ...
                case EcologicCradType.CentroReciclaje:
                    ...
                    CardDescription = "Ésta carta te permite obtener 2 puntos de sostenibilidad/turno, descartar 1 residuo/turno y obtener 1 material reciclado/turno. Permanece activa 3 turnos";
                ...
                case EcologicCradType.GranjaSolar:
                    ...
                    Clasification = "Recursos";
                    CardDescription = "Ésta carta te permite obtener 2 puntos de sostenibilidad/turno. Permanece activa 4 turnos";
                ...
                case EcologicCradType.HuertoUrbano:
                    ...
                    Clasification = "Recursos";
                    CardDescription = "Ésta carta te permite obtener 1 puntos de sostenibilidad/turno y descartar 1 residuo/turno. Permanece activa 5 turnos";

        ...
        set{
            ...
            switch(value)
            {
                ...
                case EcologicCradType.ContaminacionAire:
                    ...
                    CardDescription = "Esta carta reduce 10 pts/turno de sostenibilidad al adversario, solo puede ser anulada con una carta de ENERGIA LIMPIA";
                ...
                case EcologicCradType.CumbreClimatica:
                    ...
                    Clasification = "Colaboracion";
                    CardDescription = "Esta carta permite que todos descartan 1 residuo";
